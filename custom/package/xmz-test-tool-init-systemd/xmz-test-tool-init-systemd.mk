...
XMZ_TEST_TOOL_INIT_SYSTEMD_VERSION = 0.2.0
XMZ_TEST_TOOL_INIT_SYSTEMD_SITE = ../custom/package/xmz-test-tool-init-systemd
...
XMZ_TEST_TOOL_INIT_SYSTEMD_DEPENDENCIES = weston systemd xmz-test-tool
